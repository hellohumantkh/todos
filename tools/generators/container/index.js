...
module.exports = {
  ...
  prompts: [{
    ...
    validate: (value, answer) => {
      ...
      if ((/.+/).test(value)) {
        return pageContainers.indexOf(value) >= 0 ? 'A container with this name already exists' : true;
      }
  ...
  actions: (data) => {
    ...
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path: resolveApp('actions.js'),
        templateFile: './container/actions.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: resolveApp('tests/actions.test.js'),
      ...
      actions.push({
        type: 'add',
        path: resolveApp('selectors.js'),
        templateFile: './container/selectors.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: resolveApp('tests/selectors.test.js'),
      ...
      actions.push({
        type: 'add',
        path: resolveApp('reducer.js'),
        templateFile: './container/reducer.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: resolveApp('tests/reducer.test.js'),
    ...
    if (data.wantSaga) {
      actions.push({
        type: 'add',
        path: resolveApp('saga.js'),
        templateFile: './container/saga.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: resolveApp('tests/saga.test.js'),
